...
public class frmsales extends javax.swing.JFrame {
    ...
    public frmsales() throws IOException {
        ...
        tblsale1.getTableHeader().getColumnModel().getColumn(0).setHeaderRenderer(MyHeaderRender);
        tblsale1.getTableHeader().getColumnModel().getColumn(1).setHeaderRenderer(MyHeaderRender);
        tblsales2.getTableHeader().getColumnModel().getColumn(0).setHeaderRenderer(MyHeaderRender);
        tblsales2.getTableHeader().getColumnModel().getColumn(1).setHeaderRenderer(MyHeaderRender);
        tblsales2.getTableHeader().getColumnModel().getColumn(2).setHeaderRenderer(MyHeaderRender);
        tblsales2.getTableHeader().getColumnModel().getColumn(3).setHeaderRenderer(MyHeaderRender);
        tblsales2.getTableHeader().getColumnModel().getColumn(4).setHeaderRenderer(MyHeaderRender);
        tblsales2.getTableHeader().getColumnModel().getColumn(5).setHeaderRenderer(MyHeaderRender);
        tblsales2.getTableHeader().getColumnModel().getColumn(6).setHeaderRenderer(MyHeaderRender);
        tblsales2.getColumnModel().getColumn(0).setPreferredWidth(110);
        tblsales2.getColumnModel().getColumn(1).setPreferredWidth(190);
        tblsales2.getColumnModel().getColumn(0).setPreferredWidth(70);
    ...
    private void initComponents() {
        ...
        tblsale1.setFont(new java.awt.Font("Segoe UI", 0, 11)); // NOI18N
        ...
        tblsales2.setFont(new java.awt.Font("Segoe UI", 0, 11)); // NOI18N
        ...
        tblsales2.setShowGrid(false);
        jScrollPane2.setViewportView(tblsales2);
        if (tblsales2.getColumnModel().getColumnCount() > 0) {
            tblsales2.getColumnModel().getColumn(0).setResizable(false);
            tblsales2.getColumnModel().getColumn(1).setResizable(false);
            tblsales2.getColumnModel().getColumn(2).setResizable(false);
            tblsales2.getColumnModel().getColumn(3).setResizable(false);
            tblsales2.getColumnModel().getColumn(4).setResizable(false);
            tblsales2.getColumnModel().getColumn(5).setResizable(false);
